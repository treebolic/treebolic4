...
public class MainFrame extends treebolic.browser2.MainFrame
{
    ...
    protected void help()
    {
        @NonNull final JComponent pane = makeBrowserPane(MainFrame.class.getResource("doc/toc.html"), true);
    ...
    {
        @NonNull final JComponent pane = makeBrowserPane(MainFrame.class.getResource("doc/" + key + ".html"), true);
        addTab(pane, key, key);
    }
