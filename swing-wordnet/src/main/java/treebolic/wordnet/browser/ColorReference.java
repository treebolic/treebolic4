...
public enum ColorReference
{
	...
	// /** Relation background color */ RELATIONBGCOLOR("relation_bcolor"),
	// /** Relation foreground color */ RELATIONFGCOLOR("relation_fcolor"),
	/** Relation edge color */ RELATIONEDGECOLOR("relation_ecolor"),
