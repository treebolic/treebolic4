...
public class MainFrame extends JFrame implements HyperlinkListener
{
    ...
    protected JMenuBar makeMenuBar()
    {
        ...
        @NonNull final JMenuItem pathsMenuItem = makeItem(Messages.getString("MainFrame.datapaths"), "settings.png", Code.PATHS, 0);
    ...
    private enum Code
    {
        OPEN, OPENURL, OPENPROVIDER, OPENBUNDLE, OPENDESERIALIZE, SERIALIZE, SETTINGS, PATHS, ABOUT, HELP
    }
