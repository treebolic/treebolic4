...
public class FtpClient extends TransferProtocolClient
{
	...
	static public class RegexpPool
	{
		...
		public Object delete(String re)
		{
			...
			int len = re.length() - 1;
			int i;
			@SuppressWarnings("unused") boolean prefix = true;
	...
	/**
	 * Matches non-proxy host
	 *
	 * @param host host
	 * @return true if it matches o non-proxy host
	 */
	 ...
	 * @param proxy proxy
	 */
	public FtpClient(final Proxy proxy)
	{
		this.proxy = proxy;
	}
