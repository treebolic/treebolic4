...
public class PopupMenu implements treebolic.glue.iface.component.PopupMenu<Component, ActionListener>
{
	...
	@Override
	public void addItem(final int labelIdx, @NonNull final String label, final int imageIndex, @NonNull final ActionListener listener)
	{
		throw new NotImplementedException();
	}

	@Override
	public void addItem(final int labelIdx, final int imageIndex, @NonNull final ActionListener listener)
	{
		throw new NotImplementedException();
	}
